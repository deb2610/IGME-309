...
public:
	...
	*/
	...
	-	Matrix4 a_m4Transform -> Transformation where the entity will spawn.
	OUTPUT: ---
	*/
	void AddEntity(String a_sFileName, String a_sUniqueID = "NA", matrix4 a_m4Transform = IDENTITY_M4);
	/*
